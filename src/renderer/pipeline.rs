            ...
            buffers: &[
                ...
                wgpu::VertexBufferLayout {
                    ...
                    attributes:   &[
                        ...
                        wgpu::VertexAttribute { shader_location: 10, format: wgpu::VertexFormat::Float32x4, offset:  0 },
                        wgpu::VertexAttribute { shader_location: 11, format: wgpu::VertexFormat::Float32x4, offset: 16 },
                        wgpu::VertexAttribute { shader_location: 12, format: wgpu::VertexFormat::Float32x4, offset: 32 },
                        wgpu::VertexAttribute { shader_location: 13, format: wgpu::VertexFormat::Float32x4, offset: 48 },
                        // color_metallic (rgb + metallic)
                        wgpu::VertexAttribute { shader_location: 14, format: wgpu::VertexFormat::Float32x4, offset: 64 },
                        // roughness_ao_pad
                        wgpu::VertexAttribute { shader_location: 15, format: wgpu::VertexFormat::Float32x4, offset: 80 },
                    ],
                },
            ],
        },
